...
@fmt:lex-etcbc-full={lexa}{punca}{after}
...
@fmt:text-source-extra={fulla}{after}
@fmt:text-source-full={glypha}{punca}{after}
@fmt:text-trans-extra={fulle}{after}
...
@dateWritten=2019-04-25T14:40:18Z
